...
The following link will [Download Course Materials](/scripts/course_materials.cmd) to the Downloads Folder.
Then just double-click on the file and select an option.
